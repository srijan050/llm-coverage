...
class ChatGPT(BaseLLM):
    def __init__(  
            ...
            prioritise_harder_bins: bool = False,  
    ):  
        ...
        self.long_context_model_name = "gpt-4" 
        ...
        for delay in [2**x for x in range(0, 6)]:  
            try:  
                ...
                if any(error_type in str(type(e)) for error_type in [  
                    'ServiceUnavailableError', 'APIError', 'Timeout', 'APITimeoutError'  
                ]):  
                ...
                self.recent_msgs.append(response_message)  
                ...
                return response_content, (input_token, output_token, total_token)
